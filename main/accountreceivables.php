	...
	<div class="span2">
          <div class="well sidebar-nav">
              ...
              <li><a href="#"> DASHBOARD </a></li> 
				...
				<li><a href="collection.php?d1=0&d2=0"> COLLECTION REPORT</a>                     </li>
				<li class="active"><a href="accountreceivables.php?d1=0&d2=0"> ACCOUNT RECEIVABLE REPORT</a>    </li>
				...
				<li><a href="purchaseslist.php"> PURCHASES</a></li>
				</ul>              
          </div><!--/.well -->
        </div><!--/span-->
	<div class="span10">
