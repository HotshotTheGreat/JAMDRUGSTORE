...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="salesreport.php?d1=0&d2=0"> TRANSACTION REPORT</a>                </li>
...
<button  style="float:right;" class="btn btn-success btn-mini"><a href="javascript:Clickheretoprint()"><i class="icon-print"></i> Print</button></a>

</div>
<form action="salesreport.php" method="get">
<center><strong>From : <input type="text" style="width: 223px; padding:14px;" name="d1" class="tcal" placeholder="Date" /> To: <input type="text" style="width: 223px; padding:14px;" name="d2" class="tcal" placeholder="Date" />
 <button class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" type="submit"> Search</button>
</strong></center>
</form>
<div class="content" id="content">
<div style="font-weight:bold; text-align:center;font-size:14px;margin-bottom: 15px;">
Transaction Report From&nbsp;<?php echo $_GET['d1'] ?>&nbsp;To&nbsp;<?php echo $_GET['d2'] ?>
</div>
